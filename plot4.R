...
par(mfrow = c(2, 2))
plot(datet,finaldt$Global_active_power, xlab="", ylab="Global Active Power",type="l")

plot(datet,finaldt$Voltage,xlab="datetime",ylab="Voltage",type="l")
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lwd=1,lty=1,bty="n")

plot(datet,finaldt$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l")
dev.off()